...
namespace Spax {
     ...
     **/
    [AddComponentMenu("FixedPoint/Physics/BoxCollider2D", 0)]
        ...
        public FPVector2 size {
            ...
            set {
                ...
                if (_body != null) {
                    ...
                    ((Physics2D.PolygonShape)_body.FixtureList[0].Shape).Vertices = Spax.Physics2D.PolygonTools.CreateRectangle(sizeScaled.x * FP.Half, sizeScaled.y * FP.Half);
                }

...
namespace Spax
{
    ...
    **/
    public class FPPhysics2D {
        ...
        public enum FPCapsuleDirection2D {
        ...
        /**
        *  @brief Returns the first {@link FPCollider2D} within a circular area. Returns null if there is none.
        *  
        ...
        **/
        ...
        /**
        *  @brief Returns all {@link FPCollider2D} within a small circular area. Returns null if there is none.
        *  
        *  @param point Center of the point in world space.
        *  @param layerMask Unity's layer mask to filter objects.
        **/
        ...
        **/
        ...
        /**
        *  @brief Returns all {@link FPCollider2D} within a box area. Returns null if there is none.
        *  
        *  @param point Center of the box in world space.
        *  @param size Size of the box.
        *  @param angle Rotation angle in degrees of the box.
        ...
        **/
        ...
        /**
        *  @brief Returns the first {@link FPCollider2D} within a capsule area. Returns null if there is none.
        *  
        ...
        *  @param layerMask Unity's layer mask to filter objects.
        **/
        public static FPCollider2D OverlapCapsule(FPVector2 point, FPVector2 size, FPCapsuleDirection2D direction, FP angle, int layerMask = UnityEngine.Physics.DefaultRaycastLayers) {
        ...
        **/
        ...
        /**
        *  @brief Cast a circle and returns a {@link FPRaycastHit2D} with information about the first {@link FPCollider2D} found. Returns null if there is none.
        *  

...
namespace Spax {
    ...
    public class PhysicsWorldManager : IPhysicsManager {
        ...
        public FPRaycastHit Raycast(FPRay ray, FP maxDistance, int layerMask, RaycastCallback callback = null)
        {
            IBody hitBody;
            FPVector hitNormal;
            FP hitFraction;
        ...
        private void CollisionEnter(Contact c) {
            CollisionDetected(c.body1, c.body2, c, "OnFixedCollisionEnter");
        }

        private void CollisionStay(Contact c) {
            CollisionDetected(c.body1, c.body2, c, "OnFixedCollisionStay");
        }

        private void CollisionExit(RigidBody body1, RigidBody body2) {
            CollisionDetected(body1, body2, null, "OnFixedCollisionExit");
        }

        private void TriggerEnter(Contact c) {
            CollisionDetected(c.body1, c.body2, c, "OnFixedTriggerEnter");
        }

        private void TriggerStay(Contact c) {
            CollisionDetected(c.body1, c.body2, c, "OnFixedTriggerStay");
        }

        private void TriggerExit(RigidBody body1, RigidBody body2) {
            CollisionDetected(body1, body2, null, "OnFixedTriggerExit");
        }

...
namespace Spax {
    ...
    [Serializable]
    [ExecuteInEditMode]
    public abstract class FPCollider2D : SpaxBehavior, ICollider {
        ...
        /**
         *  @brief Creates the shape related to a concrete implementation of FPCollider.
         **/
        ...
        public virtual void OnDrawGizmos() {
            ...
            Vector3 position = _body != null ? _body.FPPosition.ToVector() : (transform.position + ScaledCenter.ToVector());
        ...
        /**
         *  @brief Draws the specific gizmos of concrete collider (for example "Gizmos.DrawWireCube" for a {@link FPBoxCollider}).
         **/

...
namespace Spax {
    ...
    /**
    * @brief Represents a set of configurations for Spax.
    **/
    public class FixedPointConfig : ScriptableObject {
        ...
        /**
         * @brief Time between each FixedPoint's frame.
         **/
        public FP lockedTimeStep = 0.02f;

        public FixedPointConfig() {
        }

...
namespace Spax.Physics3D {
    ...
    public class CollisionSystemSAP : CollisionSystem
    {
        ...
        /// which start at rayOrigin and end in rayOrigin + rayDirection.
        /// </summary>
        public override bool Raycast(FPVector rayOrigin, FPVector rayDirection, RaycastCallback raycast, int layerMask, out RigidBody body, out FPVector normal, out FP fraction)
        {
            body = null; normal = FPVector.zero; fraction = FP.MaxValue;

...
namespace Spax.Physics3D {
    ...
    public abstract class CollisionSystem
    {
        ...
        public abstract bool Raycast(FPVector rayOrigin, FPVector rayDirection, RaycastCallback raycast, int layerMask, out RigidBody body, out FPVector normal, out FP fraction);

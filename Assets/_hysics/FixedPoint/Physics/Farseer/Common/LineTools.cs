...
namespace Spax.Physics2D
{
    ...
    public static class LineTools
    {
        ...
        public static bool LineIntersect2(ref FPVector2 a0, ref FPVector2 a1, ref FPVector2 b0, ref  FPVector2 b1, out FPVector2 intersectionPoint)
        {
            ...
            //AABB early exit
            if (Spax.FPMath.Max(x1, x2) < Spax.FPMath.Min(x3, x4) || Spax.FPMath.Max(x3, x4) < Spax.FPMath.Min(x1, x2))
                return false;

            if (Spax.FPMath.Max(y1, y2) < Spax.FPMath.Min(y3, y4) || Spax.FPMath.Max(y3, y4) < Spax.FPMath.Min(y1, y2))
                return false;

...
namespace Spax.Physics2D
{
    ...
    internal static class EarclipDecomposer
    {
        ...
        // FP - public static List<Vertices> ConvexPartition(Vertices vertices, FP tolerance = 0.001f)
            ...
            while (vNum > 3)
            {
                ...
                for (int i = 0; i < vNum; ++i)
                {
                    if (IsEar(i, xrem, yrem, vNum))
                    {
                        ...
                        FP minCross = Spax.FPMath.Min(cross12, Spax.FPMath.Min(cross23, cross31));

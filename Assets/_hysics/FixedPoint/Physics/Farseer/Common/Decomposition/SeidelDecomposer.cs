...
namespace Spax.Physics2D
{
    ...
    internal static class SeidelDecomposer
    {
        ...
        // FP - public static List<Vertices> ConvexPartition(Vertices vertices, FP sheer = 0.001f)
        ...
        // FP - public static List<Vertices> ConvexPartitionTrapezoid(Vertices vertices, FP sheer = 0.001f)

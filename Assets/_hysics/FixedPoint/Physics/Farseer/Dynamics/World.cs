...
namespace Spax.Physics2D
{
    ...
    /// </summary>
    public class World : Spax.IWorld
    {
        internal FP _invDt0;
            ...
            for (; ; )
            {
                ...
                for (int i = 0; i < ContactManager.ContactList.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            alpha = Spax.FPMath.Min(alpha0 + (1.0f - alpha0) * beta, 1.0f);
                        }
                        else
                        {
                            alpha = 1.0f;
        ...
        public List<Spax.IBody> Bodies() {
            List<Spax.IBody> bodies = new List<Spax.IBody>();
            for (int index = 0; index < BodyList.Count; index++) {

...
namespace Spax.Physics2D
{
    ...
    public class Body : IDisposable, IBody2D
    {
        ...
        // FP - public Body(World world, Vector2? position = null, FP rotation = 0, object userdata = null)
        ...
        //Spax addition
        public void SetLinearVelocity(FPVector2 impulse)
        {
            SetLinearVelocity(ref impulse);
        }
        public void SetForce(FPVector2 impulse)
        {
            SetForce(ref impulse);
        }
        ...
        //a Spax addition
        public void SetLinearVelocity(ref FPVector2 velocity)
        {
            if (_bodyType != BodyType.Dynamic)
            {
                return;
        ...
        public void SetForce(ref FPVector2 velocity)
        {
            if (_bodyType != BodyType.Dynamic)
            {
                return;
        ...
        public FPVector2 FPLinearVelocity
        {
            get
            {
        ...
        public void FPApplyForce(FPVector2 force)
        {
            this.ApplyForce(force);
        }

        public void FPApplyForce(FPVector2 force, FPVector2 position)
        {
            this.ApplyForce(force, position);
        }

        public void FPApplyImpulse(FPVector2 force)
        {
            this.ApplyLinearImpulse(force, force);
        }

        public void FPApplyImpulse(FPVector2 force, FPVector2 position)
        {
            this.ApplyLinearImpulse(force, position);
        }

        //a Spax addition
        public void FPSetVelocity(FPVector2 force)
        {
            this.SetLinearVelocity(force);
        }
        public void FPSetForce(FPVector2 force)
        {
            this.SetForce(force);
        }

        public void FPApplyTorque(FPVector2 force)
        {

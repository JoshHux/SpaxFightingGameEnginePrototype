...
namespace Spax
{
    ...
    public struct FPVector4
    {
        ...
        public FPVector4 normalized
        {
            get
            {
                FPVector4 result = new FPVector4(this.x, this.y, this.z, this.w);
                result.Normalize();
        ...
        {
            FPVector4 result;
            FPVector4.Min(ref value1, ref value2, out result);
            return result;
        }
        ...
        {
            FPVector4 result;
            FPVector4.Max(ref value1, ref value2, out result);
            return result;
        }
        ...
        {
            return FPVector4.Dot(ref vector1, ref vector2);
        }
        ...
        {
            return FPVector4.Dot(ref value1, ref value2);
        }
        #endregion
        ...
        {
            FPVector4 result;
            FPVector4.Multiply(ref value1, value2, out result);
            return result;
        }
        #endregion
        ...
        {
            FPVector4 result; FPVector4.Subtract(ref value1, ref value2, out result);
            return result;
        }
        #endregion
        ...
        public static FPVector4 operator +(FPVector4 value1, FPVector4 value2)
        {
            FPVector4 result; FPVector4.Add(ref value1, ref value2, out result);
            return result;
        }
        #endregion
        ...
        {
            return new FPVector(this.x, this.y, this.z);
        }
    }

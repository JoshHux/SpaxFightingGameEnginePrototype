...
namespace Spax
{
    ...
    public struct FPMatrix4x4
    {
        ...
        public static FPMatrix4x4 Translate(FPVector translation)
        {
        ...
        /// <returns>The scaling matrix.</returns>
        public static FPMatrix4x4 Scale(FP xScale, FP yScale, FP zScale, FPVector centerPoint)
        {
            FPMatrix4x4 result;
        ...
        /// <returns>The scaling matrix.</returns>
        public static FPMatrix4x4 Scale(FPVector scales)
        {
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static FPMatrix4x4 Scale(FPVector scales, FPVector centerPoint)
        {
        ...
        public static FPMatrix4x4 TransformToMatrix(ref FPTransform transform)
        {
            FPMatrix4x4 result;

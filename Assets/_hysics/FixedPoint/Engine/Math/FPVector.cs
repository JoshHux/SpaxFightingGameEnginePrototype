...
namespace Spax
{
    ...
    public struct FPVector
    {
        ...
        public static FPVector Project(FPVector vector, FPVector onNormal)
        {
        ...
        public static FPVector ProjectOnPlane(FPVector vector, FPVector planeNormal)
        {
        ...
        {
            return new FPVector4(this.x, this.y, this.z, FP.One);
        }
